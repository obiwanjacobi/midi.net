...
{
    /// <summary>
    /// The MidiOutPortChainManager manages a chain of <see cref="IMidiSender"/> components
    /// that starts with a <see cref="MidiOutPort"/>.
    /// </summary>
    public class MidiOutPortChainManager : MidiSenderChainManager<IMidiSender>
    {
        /// <summary>
