...
namespace CannedBytes.Midi
{
    ...
    [Obsolete]
    public class MidiStreamOutPortException : MidiOutPortException
    {
        //
        ...
        public MidiStreamOutPortException(string message, Exception inner) : base(message, inner) { }
        ...
        protected MidiStreamOutPortException(
